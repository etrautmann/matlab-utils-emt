...
#
#		There is a section at the end of this file where these
#		variables can be set and made to apply to all architectures.
#		You must remove the comment character '#' before they can
#		have effect. Remember that they supersede any architecture
#		specific value for that variable.
#
...
# $Revision: 1.14 $  $Date: 1994/09/02 11:53:33 $
#----------------------------------------------------------------------------
#
# Determine the arch.
#
...
# cmex & fmex
	    MATLAB=
	    CC=
       	    CFLAGS='$CFLAGS -qfloat=nomaf'
       	    FC=
       	    FFLAGS='$FFLAGS -qfloat=nomaf'
       	    LD_FCLIBS=
# cmex only
	    CCLIBS=
	    FC_CCLIBS=
...
#----------------------------------------------------------------------------
	...
	sgi)
#
# The default action of cmex and fmex is to generate mex files which will run
# on R2000/R3000/R4000 based machines.  If you wish to optimize using the mips2
# instruction set, replace the CFLAGS, FFLAGS and LDFLAGS lines with the
# commented out line found directly below it.
#----------------------------------------------------------------------------
# cmex & fmex
	    MATLAB=
	    CC=
       	    ...
       	    FC=
       	    FFLAGS='$FFLAGS -mips2'
	    LDFLAGS='$LDFLAGS -L/usr/lib/mips2'
       	    LD_FCLIBS=
# cmex only
       	    LD_CCLIBS=
#----------------------------------------------------------------------------
